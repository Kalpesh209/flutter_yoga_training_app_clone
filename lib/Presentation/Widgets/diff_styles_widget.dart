        ...
        Padding(
          ...
          child: Container(
            margin: EdgeInsets.only(
                top: AppConstants.appPadding * 3,
                bottom: AppConstants.appPadding * 2),
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.only(
                      ...
                      right: AppConstants.appPadding * 3,
                      top: AppConstants.appPadding),
                  child: Text(
                    style.name,
                    style: TextStyle(
                      fontSize: 16,
                ...
                Padding(
                  padding: const EdgeInsets.only(
                      left: AppConstants.appPadding / 2,
                      right: AppConstants.appPadding / 2,
                      bottom: AppConstants.appPadding),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Row(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(
              ...
              vertical: AppConstants.appPadding),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(
        ...
        Padding(
          padding: const EdgeInsets.only(left: AppConstants.appPadding / 2),
          child: Container(
